...
public class msgall5 extends AppCompatActivity {
    EditText txtm;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgall5);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msgs.equals("")){
                    Toast.makeText(msgall5.this,"TYPE YOUR MESSAGE",Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(msgall5.this,"Message Sent to all",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(msgall5.this,Class_List.class);
