...
public class msgall8 extends AppCompatActivity {
    EditText txtm;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgall8);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msgs.equals("")){
                    Toast.makeText(msgall8.this,"TYPE YOUR MESSAGE",Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(msgall8.this,"Message Sent to all",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(msgall8.this,Class_List.class);
