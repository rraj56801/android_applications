...
public class msgall9 extends AppCompatActivity {
    EditText txtm;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgall9);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msgs.equals("")){
                    Toast.makeText(msgall9.this,"TYPE YOUR MESSAGE",Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(msgall9.this,"Message Sent to all",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(msgall9.this,Class_List.class);
