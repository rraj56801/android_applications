...
public class msgallukg extends AppCompatActivity {
    EditText txtm;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgallukg);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msgs.equals("")){
                    Toast.makeText(msgallukg.this,"TYPE YOUR MESSAGE",Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(msgallukg.this,"Message Sent to all",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(msgallukg.this,Class_List.class);
